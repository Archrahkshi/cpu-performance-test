...
inline void sse2_benchmark(const std::vector<int> &first, const std::vector<int> &second) {
...
inline void avx2_benchmark(const std::vector<int> &first, const std::vector<int> &second) {
